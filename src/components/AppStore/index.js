...
class AppStore extends Component {
  ...
  getCategorizedApps = searchResults => {
    const {activeTabId} = this.state
    const filterApps = searchResults.filter(
  ...
  render() {
    const {activeTabId} = this.state
    const searchResults = this.searchedApps()
    const filterApps = this.getCategorizedApps(searchResults)
    return (
